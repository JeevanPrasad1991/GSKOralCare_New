...
public class NovaminActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.novamin_layout);
		
		//btnOther=(Button) findViewById(R.id.other);
		btnnext=(Button) findViewById(R.id.novminnext);
	...
	public void onClick(View v) {
		...
		case R.id.novminnext:
			
			Intent in = new Intent(getApplicationContext(),VideoSRNPActivity.class);
			startActivity(in);
			finish();
