...
public class RapidRelief_Activity extends Activity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.rapidrelief);
		
		 selected_language = this.getSharedPreferences("user_detail",
					Context.MODE_WORLD_WRITEABLE).getString("language", "");
		
		video = (VideoView) findViewById(R.id.oralcarebetterhealth_questionico);
		 SrcPath = "/sdcard/Download/RapidRelief/" + selected_language + ".mp4";
		...
		adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
			language_spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
				...
				public void onItemSelected(AdapterView<?> arg0, View arg1,
					...
					/*//if(item != 0)
					//{					
					selected_languageid = String.valueOf(item - 1);				
					selected_language = languagearray.get(item - 1).getLanguage();
					//}
*/					selected_languageid = String.valueOf(item);				
				...
				previous_language_name = languagearray
				 ...
				 language_spinner.setSelection(previous_language_id);
				 }
		...
		gd.setOnDoubleTapListener(new OnDoubleTapListener() {
			...
			public boolean onDoubleTap(MotionEvent e) {
				...
				i.putExtra("class", "rapidrelief");
				startActivity(i);
				RapidRelief_Activity.this.finish();
				return false;
			}
