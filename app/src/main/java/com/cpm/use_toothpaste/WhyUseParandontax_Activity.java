...
public class WhyUseParandontax_Activity extends Activity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.whyuseparodontax);
		
		selected_language = this.getSharedPreferences("user_detail",
				Context.MODE_WORLD_WRITEABLE).getString("language", "");
		
		video = (VideoView) findViewById(R.id.whyuseparodontax_questionico);
		SrcPath = "/sdcard/Download/Paradontax/" + selected_language + ".wmv";
		
		
	   
		 language_spinner = (Spinner) findViewById(R.id.language_name);
			...
			language_spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
				...
				public void onItemSelected(AdapterView<?> arg0, View arg1,
					...
					if (!selected_language
						...
						if(selected_language.equalsIgnoreCase("Malayalam"))
						{
							selected_language="Malyalam";
						}
						if(selected_language.equalsIgnoreCase("Telugu"))
						{
							selected_language="Telegu";
						}
						if(selected_language.equalsIgnoreCase("Bangla"))
						{
							selected_language="Bengali";
						}
						...
						{
					 SrcPath = "/sdcard/Download/Paradontax/" + selected_language + ".mp4";
						}
		...
		Button best_offer = (Button) findViewById(R.id.bestoffer);
		best_offer.setOnClickListener(this);

		mdatabaseObj = new GskDatabase(getApplicationContext());
		mdatabaseObj.openDB();

		String sensodyne_id = mdatabaseObj.getBrandId("Parodontax");
		e2 = this.getSharedPreferences("brand_count",
				Context.MODE_WORLD_READABLE).edit();

		e2.putString("brand", "Parodontax");
		...
		back.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivity(i);
				WhyUseParandontax_Activity.this.finish();
			}
		});
