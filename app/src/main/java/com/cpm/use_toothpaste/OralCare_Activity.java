...
public class OralCare_Activity extends Activity implements OnGestureListener,
		OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.oralcarebetterhealth);
		...
		SrcPath = "/sdcard/Download/Sensodyne.wmv";
		...
		adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
			language_spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
				...
				public void onItemSelected(AdapterView<?> arg0, View arg1,
					...
					{
				 SrcPath = "/sdcard/Download/Sensodyne/" + selected_language + ".mp4";
					}
					//}
