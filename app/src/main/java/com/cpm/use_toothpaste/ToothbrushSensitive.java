...
public class ToothbrushSensitive extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.toothpastesensitive_layout);
		
		//btnOther=(Button) findViewById(R.id.other);
		btnnext=(Button) findViewById(R.id.toothsensenext);
	...
	public void onClick(View v) {
		...
		case R.id.toothsensenext:
			
			Intent in = new Intent(getApplicationContext(),DesignWithExperts.class);
			startActivity(in);
			finish();
