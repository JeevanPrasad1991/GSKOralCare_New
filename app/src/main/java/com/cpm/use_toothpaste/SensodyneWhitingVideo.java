...
public class SensodyneWhitingVideo extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.sensodyne_whitening_video_layout);

		video = (VideoView) findViewById(R.id.videoviewsrnp);
		SrcPath = Environment.getExternalStorageDirectory().getPath()+"/GSKOralCare/vodeogsk.mp4";
	...
	public void onClick(View v) {
		...
		case R.id.btnnext:
			...
			Intent in = new Intent(getApplicationContext(),SensodyneWhiteningTextActivity.class);
			startActivity(in);
			finish();
