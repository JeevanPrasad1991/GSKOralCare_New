...
public class DrRecommendedActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.drrecomend_layout);
		
		//btnOther=(Button) findViewById(R.id.other);
		btnnext=(Button) findViewById(R.id.drrecommendnext);
	...
	public void onClick(View v) {
		...
		case R.id.drrecommendnext:
			
			Intent in = new Intent(getApplicationContext(),VideoSensationActivity.class);
			startActivity(in);
			finish();
