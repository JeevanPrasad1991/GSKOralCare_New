...
public class InstantRelief extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.instantrelief_layout);
		
		//btnOther=(Button) findViewById(R.id.other);
		btnnext=(Button) findViewById(R.id.instantreliefnext);
	...
	public void onClick(View v) {
		...
		case R.id.instantreliefnext:
			
			//Intent in = new Intent(getApplicationContext(),ToothpasteSensitive.class);
			Intent in = new Intent(getApplicationContext(),VideoRapidActivity.class);
			startActivity(in);
			finish();
