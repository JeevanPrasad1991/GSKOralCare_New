...
public class OthersRNP extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.othersrnp_layout);
		
		//btnOther=(Button) findViewById(R.id.other);
		btnnext=(Button) findViewById(R.id.othernext);
	...
	public void onClick(View v) {
		...
		case R.id.othernext:
			...
			Intent in = new Intent(getApplicationContext(),NovaminActivity.class);
			startActivity(in);
			finish();
